...
using TopicCallback = std::function<void(const std::string& topic, const std::string& serialized_msg)>;
using ServiceCallback = std::function<void(bool success, const std::string& response_json, double elapsed_ms)>;
...
public:
    ...
    std::string get_service_request_json(const std::string& service_name, const std::string& type_str);
    std::string get_action_goal_json(const std::string& action_name, const std::string& type_str);

    // Dynamic subscription
    bool subscribe_topic(const std::string& topic, const std::string& type_str, TopicCallback callback);
    void unsubscribe_topic(const std::string& topic);
    bool is_topic_subscribed(const std::string& topic) const;

    // Service call
    void call_service_async(const std::string& service_name, const std::string& type_str,
